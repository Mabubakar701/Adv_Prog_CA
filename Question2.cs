    ...
    class FileExtensionSystem
    {
        ...
        private void InitializeDatabase()
        {
            ...
            AddExtension(new FileExtensionTypeInfo(
                ...
                "High-quality video with multiple audio tracks and subtitles",
                new List<string> { "VLC",  "Windows Media Player" }
            ));
            ...
            AddExtension(new FileExtensionTypeInfo(
                ...
                "Lossless audio compression for audiophiles",
            ...
            AddExtension(new FileExtensionTypeInfo(
                ...
                "Universal document format preserving layout",
            ...
            AddExtension(new FileExtensionTypeInfo(
                ".rar", "Compressed",
                "RAR Archive",
                "Compressed file archive with better compression",
            ...
            AddExtension(new FileExtensionTypeInfo(
                ...
                new List<string> { "VS Code", "Notepad++", "Any Text Editor" }
            ));
        }
        ...
        {
            // Find extensions that start with the same letters
            ...
            while (running)
            {
                ...
                switch (choice)
                {
                    ...
                    case "2":
                        ...
                        {
                            system.BrowseByCategory(cat);
                        }
                        break;

                    case "3":
                        system.ListAllExtensions();
                        break;
